...
//       topD.innerHTML = `
//         <div class="ip-address">
//           <h2>IP Address : <span id="ip-details">${data.ip}</span></h2>
//         </div>
//         <div class="top-details">
//         <div class="lat-long">
//             <h2 id="lat">Lat: ${data.latitude}</h2>
//             <h2 id="long">Long: ${data.longitude}</h2>
//           </div>
//           <div class="city-region">
//             <h2 id="city">City: ${data.city}</h2>
//             <h2 id="region">Region: ${data.region}</h2>
//           </div>
//           <div class="org-host">
//             <h2 id="org">Organisation: ${data.org}</h2>
//             <h2 id="host">Hostname: ${data.network}</h2>
//           </div>
//           </div>
//         `;
//       mapContainer.innerHTML = `<iframe
...
//     //   </div>`
//     //   })
//     renderCards(data[0].PostOffice,searchTerm="");
//   }

//   //   function renderCards(pincode){
//   //     console.log(pincode);
//   //     pincode.forEach((pin)=>{
//   //         cards.innerHTML+=`
//   //         <div class="card">
...
//   function renderCards(pincode, searchTerm) {
//     console.log(pincode);
//     cards.innerHTML = "";
